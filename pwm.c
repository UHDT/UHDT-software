...
void pwm_timer_init() {
    ...
    */
    TIM_BaseStruct.TIM_Period = PERIOD; /* 10kHz PWM */
...
void pwm_init() {
    ...
    */
    ...
    TIM_OCStruct.TIM_Pulse = 4400; /* 50% duty cycle */
    TIM_OC2Init(TIM4, &TIM_OCStruct);
    TIM_OC2PreloadConfig(TIM4, TIM_OCPreload_Enable);

    TIM_OCStruct.TIM_Pulse = 4400; /* 75% duty cycle */
    TIM_OC3Init(TIM4, &TIM_OCStruct);
    TIM_OC3PreloadConfig(TIM4, TIM_OCPreload_Enable);

    TIM_OCStruct.TIM_Pulse = 4400; /* 100% duty cycle */
...
void pwm_run_motor(int percent, int delay_ms)
{
    ...
    for (i = 0; i < pwm_difference; ++i)
    {
        ...
        TIM_SetCompare2(TIM4, g_pwm_value);
        TIM_SetCompare3(TIM4, g_pwm_value);
        TIM_SetCompare4(TIM4, g_pwm_value);
